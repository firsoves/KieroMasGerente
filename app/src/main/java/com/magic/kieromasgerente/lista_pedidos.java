...
public class lista_pedidos extends AppCompatActivity {
    ...
    public void menu(View view) {
        Intent intentInicio = new Intent(lista_pedidos.this, config_inicio.class);
        startActivity(intentInicio);

        finish();
    }

    public void abrir_pedido(View view) {
        Intent intentInicio = new Intent(lista_pedidos.this, info_pedido.class);
        startActivity(intentInicio);
